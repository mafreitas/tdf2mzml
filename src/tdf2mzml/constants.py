...
# Instrument / source
CV_BRUKER_INSTRUMENT: str = "MS:1001534"    # Bruker Daltonics instrument model
...
CV_MCP_DETECTOR: str = "MS:1000116"         # microchannel plate detector
...
CV_PYTHON: str = "MS:1000799"               # ProteoWizard/Python-based software (placeholder)
